"""
Module for running live tests with pytest, setting environment variables to enable live testing.
This script can run all live tests or a specific test based on command line arguments.
"""
